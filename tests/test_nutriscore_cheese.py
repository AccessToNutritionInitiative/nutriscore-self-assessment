...
DATA_FILE = Path(__file__).parent / "data" / "cheese_foods.json"
...
def test_cheese_nutriscore(nutriscore_request: ProductRequest, expected_score: int, expected_grade: str):
