...
DATA_FILE = Path(__file__).parent / "data" / "red_meat_foods.json"
...
def test_red_meat_nutriscore(nutriscore_request: ProductRequest, expected_score: int, expected_grade: str):
